    ...
    <footer className="bg-secondary py-12">
      <div className="container">
        <div className="grid gap-8 md:grid-cols-4">
          <div>
            <h3 className="font-bold text-lg mb-4">ProjectMarket</h3>
            <p className="text-muted-foreground">
              Your one-stop shop for high-quality, ready-to-use projects built with modern technologies.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link to="/purchased" className="text-muted-foreground hover:text-foreground transition-colors">
                  Purchased Projects
                </Link>
              </li>
              <li>
          ...
          <div>
            ...
            <address className="not-italic text-muted-foreground">
              ...
              <p className="mt-2">Email: info@projectmarket.com</p>
